...
declare namespace PIXI {
  type Sprite = _PIXI.Sprite;
  type Texture = _PIXI.Texture;
  type Rectangle = _PIXI.Rectangle;
  type Matrix = _PIXI.Matrix;
  type BaseTexture = _PIXI.BaseTexture;
  type Loader = _PIXI.Loader;
  type LoaderResource = _PIXI.ILoaderResource;
  type Container = _PIXI.Container;
  type Graphics = _PIXI.Graphics;
  type DisplayObject = _PIXI.DisplayObject;
  type SimpleMesh = _PIXI.SimpleMesh;
}
// eslint-enable
...
declare namespace PIXI.spine {
  ...
  function syncImageLoaderAdapter(
    baseUrl: any,
    crossOrigin: any
...
declare namespace PIXI.spine {
  ...
  class SpineSprite extends _PIXI.Sprite implements ISpineDisplayObject {
    region?: core.TextureRegion;
    attachment?: core.Attachment;
  }
  class SpineMesh extends _PIXI.SimpleMesh implements ISpineDisplayObject {
    region?: core.TextureRegion;
    attachment?: core.Attachment;
    constructor(
      texture: PIXI.Texture,
  ...
  class Spine extends _PIXI.Container {
    ...
    createSprite(
      slot: core.Slot,
      attachment: core.RegionAttachment,
      defName: string
    ): SpineSprite;

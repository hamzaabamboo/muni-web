...
declare abstract class CurveTimeline implements Timeline {
...
export declare class SpineSprite
  extends PIXI.Sprite
...
export declare class Spine extends PIXI.Container {
  ...
  createGraphics(slot: Slot, clip: ClippingAttachment): PIXI.Graphics;
...
type IPIXI = typeof PIXI & { spine: Spine };
export type { IPIXI };
